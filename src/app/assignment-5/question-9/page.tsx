...
const ModalDemoPage: React.FC = () => {
  ...
  const getModalContent = () => {
    if (modalType === "success") {
      ...
      return (
        <Typography color="error.main">Failed to create post.</Typography>
      );
    } else {
      return <Typography>This is a general information modal.</Typography>;
    }
  };
  ...
  return (
    <div>
      ...
      <main style={{ textAlign: "center", padding: "2rem" }}>
        <Button variant="outlined" onClick={() => openModal("info")} sx={{ m: 1 }}>
          Show Info
        </Button>
        <Button
          variant="contained"
